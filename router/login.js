...
router.post('/login', loginControllers.loginVerification); // Lorsque l'utilisateur soumet le formulaire d'inscription, la fonction "signupValidation" du contrôleur "signupControllers" est exécutée
